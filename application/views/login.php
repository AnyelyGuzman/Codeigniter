				...
				<div id="head-form" class="card">
					<article class="card-body">
						...
						<form action="<?= base_url(); ?>index.php/principal/logueo" method="post">
							...
							<div class="form-group">
                                <a href="http://localhost/Codeigniter/index.php/principal/admin">
                                    <button type="button" class="btn btn-primary btn-block">Administrador</button>
                                </a>
							</div>
							<div class="form-group">
                                <a href="http://localhost/Codeigniter/index.php/principal/registro">
